...
//First camp:
sleep 1;
_camp_1 = [_side,format ["%1_camp_1",_task],_camp_1_pos] call CO_fnc_reconCamp;
...
//First camp:
sleep 1;
_camp_2 = [_side,format ["%1_camp_2",_task],_camp_2_pos] call CO_fnc_reconCamp;
...
//First camp:
sleep 1;
_camp_3 = [_side,format ["%1_camp_3",_task],_camp_3_pos] call CO_fnc_reconCamp;
...
_patrols = [["PATROL", 500, "YELLOW", _zonePos, "AWARE", [""], [5, "CIRCLE_L"]], 1, 1400, 12, format ["%1_Patrol",_task], _side, _faction, "MEN", "STANDARD", "AAPLANE", "CAR", 5, selectRandom ["STAG COLUMN","COLUMN","FILE"], true] call CO_fnc_enemyAssault;
