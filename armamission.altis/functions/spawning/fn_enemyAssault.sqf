params ["_wpParams","_minRadius","_maxRadius","_groupCount","_groupName","_groupSide","_groupFaction","_groupType","_menType","_airType","_groundType","_unitCount","_formation","_sim"];
...
for "_a" from 1 to _groupCount do 
{
	...
	for "_b" from 1 to _unitCount do 
	{
		switch _groupType do 
		{
			...
			case "GROUND":
			{
				_vehPos = [_spawnPos, 0, 250, 15, 0, 0.7, 0,[],[_spawnPos,[]]] call BIS_fnc_findSafePos;
