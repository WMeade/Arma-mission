params ["_wpParams","_minRadius","_maxRadius","_groupCount","_groupName","_groupSide","_groupFaction","_groupType","_menType","_airType","_groundType","_unitCount","_sim"];
private ["_target","_minRadius","_maxRadius","_groupCount","_groupName","_groupSide","_groupFaction","_groupType","_menType","_airType","_groundType","_unitCount","_a","_b","_air","_men","_ground","_wpParams"];
/*
...
Example of calling the function:
    enemies = [["SAD", 10, "YELLOW", TESTCAR, "SAFE", [""], [5, "CIRCLE_L"]], 400, 700, 12, "SPANEER", EAST, "OPF_F", "MEN", "RECON", "AAPLANE", "CAR", 3] call CO_fnc_enemyAssault; 

*/		

//List of soldiers, vehicles and air vehicles used to determine what to spawn based on function call parameters 
...
for "_a" from 1 to _groupCount do 
{
	...
	for "_b" from 1 to _unitCount do 
	{
		switch _groupType do 
		{
			...
			case "GROUND":
			{
				_unit = createVehicle [(selectRandom _ground),_spawnPos,[],25,"NONE"];
			...
			case "AIR":
			{	
				_airPos = [(_spawnPos select 0),(_spawnPos select 1),150];
		...
		case "PATROL":
		{
			switch _groupType do
			{
				...
				case "AIR":
				{
					...
					{_x flyInHeightASL [150, _loiteralt, 500];} forEach units _group;
				};
			};
		};
		default {};
...
{_x addCuratorEditableObjects [_allEnemies,true];} forEach allCurators;
_allEnemies;